...
def duplicate_folder_and_crop_images(acq_path, dest_path, x, y, width, height):
    # Create the new folder name
    folder_name = os.path.basename(acq_path)
    new_folder_name = folder_name + "_sub_images"
    new_acq_path = os.path.join(os.path.dirname(dest_path), new_folder_name)
...
duplicate_folder_and_crop_images(acq_path, acq_path, x, y, width, height)
